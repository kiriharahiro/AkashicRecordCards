...
json_path = os.path.join(current_dir, "cards_data.json")
...
<body>
    ...
    <script>
        ...
        function checkAuthentication() {
            const isUnlocked = sessionStorage.getItem("akashic_unlocked");
        ...
        async function submitPasscode() {
            ...
            if (hashedInput === SECURED_HASH) {
                sessionStorage.setItem("akashic_unlocked", "true");
                const overlay = document.getElementById("passcode-overlay");
                if (overlay) {
        ...
        function initSettings() {
            const syncEnabled = localStorage.getItem("akashic_sync_enabled") === "true";
            const savedUrl = localStorage.getItem("akashic_sync_url") || "";
            ...
            document.getElementById("settings-save-btn").addEventListener("click", async () => {
                ...
                localStorage.setItem("akashic_sync_enabled", isEnabled ? "true" : "false");
                localStorage.setItem("akashic_sync_url", url);
        ...
        async function initializeApp() {
            try {
                ...
                if (localStorage.getItem("akashic_sync_enabled") === "true") {
...
output_paths = [
    ...
    r"g:\共有ドライブ\KiriPlayPark\Tool\Antigravity\kiriplaypark-projects\AkashicRecordCard\v.02\index.html"
]
